...
describe('/reporting-ui/consumption', () => {
    ...
    describe('GET /', () => {
        ...
        it('should return 200 and the report for valid provisionSessionIds', async () => {
            ...
            const spyGenerateConsumptionReport = jest
                .spyOn(reportsService, 'generateConsumptionReport')
            ...
            expect(spyGenerateConsumptionReport).toHaveBeenCalledWith(provisionSessionArray, {
    ...
    describe('GET /details', () => {
        it('should return 200 and the filtered report details', async () => {
            ...
            const spyTransformJSONtoReport = jest
                .spyOn(reportsService, 'transformJSONtoReport')
