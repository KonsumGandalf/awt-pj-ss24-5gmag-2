...
describe('/reporting-ui/metrics', () => {
    ...
    describe('GET /', () => {
        ...
        it('should return 200 and the report for valid provisionSessionIds', async () => {
            ...
            const spyGenerateMetricsReport = jest.spyOn(reportsService, 'generateMetricsReport').mockResolvedValue(report);
            ...
            expect(spyGenerateMetricsReport).toHaveBeenCalledWith(provisionSessionArray, { provisionSessionIds: '1-3' });
    ...
    describe('GET /details', () => {
        it('should return 200 and the filtered report details', async () => {
            ...
            const spyTransformXmlToReport = jest.spyOn(reportsService, 'transformXmlToReport').mockResolvedValue(transformedJsonResponse);
